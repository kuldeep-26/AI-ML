...
# st[0] = 'bittu'          #update or manipulation
# print(st)
...
# st.insert(1,'abhi')      # insert at any position
# print(st)
...
# st.remove(0)       # if present in set
# print(st)

# st.discard(30)     # don't care present in array or not
# print(st)
...
#         max = dt[i]
#         winner = i
# print(f"{winner} is win with {max} votes")